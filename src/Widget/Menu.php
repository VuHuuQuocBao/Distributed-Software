                        ...
                        ?>
                            <div class="Container_History">
                                ...
                                <div class="Contain__InforHistory">
                                    <a style="text-decoration: none; color:rebeccapurple;width:100%" href="SanPham.php?page=Quần Áo&TheLoai=Đồ Nam&IDLoai=<?php echo $rowSK['IDTL'] ?>">
                                        <h1 style="font-size: 20px;"><u style="text-decoration: none;"><?php echo $rowSK['tenSK'] ?></h1></u>
                                    </a>
